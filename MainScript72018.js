  ...
  if ("content" in e.feed.entry[i]) var summ = e.feed.entry[i].content.$t;
                ...
                summ = summ.replace(content, ""), summ.length > 120 && (summ = "" + summ.substring(0, 100) + "...");
                    ...
                    if (c.indexOf("//www.youtube.com/embed/") > -1) {
                        ...
                        h += '<li><div class="ty-wow"><a class="ty-thumb-bonos" href="' + u + '"><img alt="' + g +'" src="'+ k +'"/><span class="tyimg-lay"/></a><div class="ty-slide-con"><div class="ty-slide-con"><div class="ty-slide-con-tab"><h3 class="ty-bonos-entry"><a href="' + u + '">' + g + '</a></h3><span class="recent-date">' + r + '</span><p class="recent-summary">'+ summ +'</p><a class="tyslide-more" href="' + u + '">قرأة المزيد </a></div></div></div></div></li>'
                }
                h += '</ul></div>';
                $(".ty-slide-show .HTML .widget-content").each(function() {
...
$(".featured .HTML .widget-content").each(function() {
 ...
 $(".post-home-image .post-thumb a").attr("style", function($this, t) {
        if (t.match("hqdefault.jpg")) {
            ...
            return t.replace("https://3.bp.blogspot.com/-Yw8BIuvwoSQ/VsjkCIMoltI/AAAAAAAAC4c/s55PW6xEKn0/s1600-r/nth.png", no_image);
        }
    });
$(document).ready(function(){
...
$(document).ready(function() {
 ...
 $(".PopularPosts ul li img").attr("src", function($this, img) {
        if (img.match("hqdefault.jpg")) {
            ...
            return img.replace("https://3.bp.blogspot.com/-Yw8BIuvwoSQ/VsjkCIMoltI/AAAAAAAAC4c/s55PW6xEKn0/s1600-r/nth.png", no_image);
        }
    });
$(document).ready(function() {
